...
/**
 * ApplicationContext是spring引导的起点
 *
 * @author zhangkx
 * @create 2020-10-13 19:32
 */
public class ZhangkxApplicationContext {
    ...
    public ZhangkxApplicationContext(Class configClass) {
        this.configClass = configClass;
    ...
    private void scan(Class configClass) {
        if (configClass.isAnnotationPresent(ComponentScan.class)) {
            ...
            ClassLoader classLoader = ZhangkxApplicationContext.class.getClassLoader();
            URL resource = classLoader.getResource(path.replace(".", "/"));
            File file = new File(resource.getFile());
            for (File f : file.listFiles()) {
                // f是class文件,只取中间的路径
                // f文件路径  E:\05-Learn\spring-study-Zhangkx\target\classes\com\Zhangkx\service\UserService.class
                // 需要 uestc.zhangkx.service.UserService
